import type { FloorColor } from './pixel-engine/types.js';
...
export const EDIT_BUTTON_BG = 'rgba(50, 160, 50, 0.85)';
export const LAYER_BUTTON_BG = 'rgba(160, 100, 50, 0.85)';
...
export const PET_SLEEP_DURATION_MIN_SEC = 10.0;
export const PET_SLEEP_DURATION_MAX_SEC = 30.0;
export const PET_SIT_DURATION_MIN_SEC = 5.0;
export const PET_SIT_DURATION_MAX_SEC = 15.0;
